...
REM Step3. copy the "~/SparkleShare/Rprofile/R/dotFiles/.Rprofile" to the ~/Rprofile
wmic ENVIRONMENT create name="HOME",username="<system>",VariableValue="%USERPROFILE%"
wmic ENVIRONMENT create name="R_HOME",username="<system>",VariableValue="C:\Program Files\R\R-3.3.1"
mklink "%USERPROFILE%/.Rprofile" "%USERPROFILE%/SparkleShare/Rprofile/R/dotFiles/R01_Win_dot_Rprofile.R"